...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-plus"></i> Tambah Alamat
      </button>
      <!-- Modal -->
              ...
              <div class="modal-body">
                <div class="mb-3">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="kode_alamat">
                  </div>
                </div>
                <div class="mb-3">
