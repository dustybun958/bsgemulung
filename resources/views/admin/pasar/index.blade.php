                            ...
                            <form action="/admin/pasar" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" required readonly class="form-control" name="koordinat"
                                            id="koordinat">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class='mb-3'>
                                            ...
                                            <select name="kantor_pengelola" required id="kantor_pengelola"
                                                class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="ruang_kesehatan" required id="ruang_kesehatan"
                                                class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="ruang_peribadatan" required id="ruang_peribadatan"
                                                class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="pemadam_kebakaran" required id="pemadam_kebakaran"
                                                class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="tempat_parkir" required id="tempat_parkir"
                                                class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="pengolahan_air_limbah" required id="pengolahan_air_limbah"
                                                class="form-control">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="align-items-center">
                                                    <a href="{{ route('pasar.edit', $data->id_pasar) }}"
                                                        class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <form id="delete-form-{{ $data->id_pasar }}"
                                                        action="/admin/pasar/{{ $data->id_pasar }}" method="POST"
                                                        class="d-inline-flex align-items-center m-0 p-0 ms-2">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                            onclick="confirmDelete({{ $data->id_pasar }})">
