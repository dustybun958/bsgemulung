...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="car-body">
    ...
    <div class="input-group mb-3">
      <button type="submit" class="btn btn-secondary col-md-12" onclick="window.open('{{ route('cetak-data-perpasar', '') }}/' + document.getElementById('nmpasar').value, '_blank')">Cetak Laporan Perpasar <i class="fas fa-print"></i> </button>
