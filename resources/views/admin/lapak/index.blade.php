                ...
                <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('lapak.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="importModalLabel">Import Lapak dari Excel</h5>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" required class="form-control" name="id_lapak"
                                                id="id_lapak" min="0" max="99999" oninput="validateInput(this)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="no" id="no"
                                                min="0" max="99999" oninput="validateInput(this)">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="tarif_dasar"
                                                id="tarif_dasar" min="0">
                                        </div>
                                    </div>
                                    <div class="mb-3">
    ...
    fw-bold p-2"
                                            ...
                                            <td class="text-start">
                                                ...
                                                <div class="align-items-center">
                                                    <a href="{{ route('lapak.edit', $data->id_lapak) }}"
                                                        class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <form id="delete-form-{{ $data->id_lapak }}"
                                                        action="/admin/lapak/{{ $data->id_lapak }}" method="POST"
                                                        class="d-inline-flex align-items-center m-0 p-0 ms-2">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                            onclick="confirmDelete({{ $data->id_lapak }})">
